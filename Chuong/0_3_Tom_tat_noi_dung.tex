...
Trong lĩnh vực an ninh mạng hiện đại, việc phát hiện các cuộc tấn công lạm dụng công cụ hợp lệ sẵn có của hệ điều hành (Living-off-the-Land - LotL) là một thách thức cốt lõi do hành vi xâm nhập bị hòa lẫn hoàn toàn vào các hoạt động quản trị thông thường. Mặc dù các mô hình phát hiện bất thường không giám sát (Unsupervised Anomaly Detection - UAD) được kỳ vọng mang lại khả năng tự động nhận diện các mối đe dọa chưa từng biết (Zero-day), hiệu năng thực tế của chúng thường suy giảm nghiêm trọng mà không có sự giải thích rõ ràng về mặt lý thuyết. Nghiên cứu này giải quyết khoảng trống tri thức đó bằng cách đề xuất một khung phân tích định lượng lý thuyết độc lập để đo lường độ khó nội tại của dữ liệu tấn công, thay vì dựa vào các đánh giá hiệu năng mang tính kinh nghiệm và phụ thuộc thuật toán.
