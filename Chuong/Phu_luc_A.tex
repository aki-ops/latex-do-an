...
\begin{itemize}
\item Đây là mục 1 - Thực sự không còn cách nào khác mới dùng đến việc bullet trong báo cáo.
\item Đây là mục 2 - Nghĩ lại thì có thể không cần dùng bullet cũng được. Cần xóa bullet và tổ chức lại hai mục này trong báo cáo cho khoa học hơn. Cần trình bày để người đọc cảm nhận được tâm huyết trong từng trang báo cáo DATN.
\end{itemize}
...
\begin{itemize}
\item Đánh dấu (bullet) là kiểu liệt kê không có thứ tự. Để sử dụng kiểu liệt kê đánh dấu, khai báo như sau\\ 
\verb$\begin{itemize}$\\
 \verb$\item$ Nội dung thứ nhất được viết ở đây.\\
\verb$\item$ Nội dung thứ hai được viết ở đây.\\
 \verb$\item$ ...\\
\verb$\end{itemize}$
\item Đánh số (numering) là kiểu liệt kê có thứ tự. Để sử dụng kiểu liệt kê đánh số, khai báo như sau\\
