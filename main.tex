...
\def \TITLE{Giới hạn của phát hiện bất thường thống kê trên Windows Endpoint: Phân tích thực nghiệm qua kiến trúc hybrid}
...
\subfile{Bia.tex} % Phần bìa
\subfile{Bia_lot.tex} % Phần bìa
% \restoregeometry
...
\subfile{Chuong/1_Mo_dau.tex} % Phần mở đầu
...
\subfile{Chuong/2_Kien_thuc_co_so.tex}
...
\subfile{Chuong/4_Thuc_nghiem_va_danh_gia.tex}
