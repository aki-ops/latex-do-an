...
\usepackage{booktabs} % Hỗ trợ vẽ bảng với các đường kẻ chuyên nghiệp (toprule, midrule, bottomrule)
...
\def \TITLE{ĐỀ XUẤT KHUNG ĐO LƯỜNG ĐỘ HÒA TRỘN HÀNH VI CỦA TIẾN TRÌNH ĐỘC HẠI TRÊN WINDOWS}
\def \AUTHOR{HOÀNG ANH TUẤN}
...
\graphicspath{{figures/}{../figures/}{Hinhve/}{../Hinhve/}} % Thư mục chứa các hình ảnh
...
\subfile{Bia} % Trang bìa ngoài
% \subfile{Bia_lot} % Phần bìa lót (Đã bỏ theo yêu cầu vì xấu)
% \restoregeometry
...
\subfile{Chuong/Mo_dau_New} % Phần mở đầu
...
\subfile{Chuong/Chuong_1_Co_so_ly_thuyet}


\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{KHUNG ĐO LƯỜNG BBS}
\label{chapter:Methodology}
\subfile{Chuong/Chuong_2_Thiet_ke_he_thong}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{THỰC NGHIỆM VÀ ĐÁNH GIÁ}
\label{chapter:Experiment}
\subfile{Chuong/Chuong_3_Thuc_nghiem_va_danh_gia}
